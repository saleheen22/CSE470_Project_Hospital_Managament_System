...
<body>
  ...
  <tr style="background-color:black;">
    ...
    <td>
      <a class = "btn-btn-success" href= "{{url('updateappointment', $appoints->id)}}" >Update</a>
    </td>
    <td>
      <a class = "btn-btn-danger" onclick = "return confirm('Are you sure to cancel your appointment')" href= "{{url('cancelappointment', $appoints->id)}}" >Cancel</a>
    </td>
